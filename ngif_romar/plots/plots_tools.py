...
def update_axis_pool_size_over_time(fig, logfile_df, save_folder_path=None, show_plot=False,
...
def make_plot_pool_size_over_time(logfile_df, save_folder_path=None, show_plot=False,
    ...
    update_axis_pool_size_over_time(fig, logfile_df, save_folder_path, show_plot, pre_process, with_and_without_preprocess)
