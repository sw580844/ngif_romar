...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page4_pushbutton_makeplot = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.page4_pushbutton_makeplot.setMinimumSize(QtCore.QSize(699, 23))
        self.page4_pushbutton_makeplot.setObjectName("page4_pushbutton_makeplot")
        self.gridLayout_7.addWidget(self.page4_pushbutton_makeplot, 0, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.page4_checkBox_laseron, 1, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.page4_centre, 2, 0, 1, 1)
        self.stackedWidget.addWidget(self.page_4)
        self.page_single_toolpath = QtWidgets.QWidget()
        self.page_single_toolpath.setObjectName("page_single_toolpath")
        self.gridLayout_8 = QtWidgets.QGridLayout(self.page_single_toolpath)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.gridLayout_9 = QtWidgets.QGridLayout()
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.single_toolpath_page_element = QtWidgets.QWidget(self.page_single_toolpath)
        self.single_toolpath_page_element.setObjectName("single_toolpath_page_element")
        self.gridLayout_9.addWidget(self.single_toolpath_page_element, 0, 0, 1, 1)
